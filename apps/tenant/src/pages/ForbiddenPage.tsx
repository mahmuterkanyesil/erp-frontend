  ...
  return (
    <main className="min-h-screen bg-background-light dark:bg-background-dark flex items-center justify-center p-6">
      <div className="text-center flex flex-col items-center gap-6 max-w-md">
        <div className="flex items-center justify-center size-20 rounded-full bg-danger/10">
          <span className="material-symbols-outlined text-danger text-[40px]">lock</span>
        </div>
        <div className="flex flex-col gap-2">
          <p className="text-5xl font-[800] text-text-main-light dark:text-text-main-dark">403</p>
